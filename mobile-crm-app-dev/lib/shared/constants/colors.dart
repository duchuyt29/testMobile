...
class AppColor {
  ...
  static Color sixTextColorLight = const Color(0xFF493083);
  static Color sevenTextColorLight = const Color(0xFF6C757D);
  static Color eightTextColorLight = const Color(0xFF2E5AAC);
  static Color niceTextColorLight = neutral3;

  static Color primaryHintColor = neutral5;
  ...
  static Color addIconButtonColor = const Color.fromARGB(255, 85, 176, 249);
  ...
  static Color errorColor = const Color(0xFFFF754C);
