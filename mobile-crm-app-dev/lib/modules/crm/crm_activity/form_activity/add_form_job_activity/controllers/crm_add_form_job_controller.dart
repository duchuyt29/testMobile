...
import 'package:ui_api/crm_api/models/activity/activity_task_detail.dart';
...
class CrmAddFormJobController extends BaseController {
  ...
  Future<void> onSubmitted() async {
    if (fbKey.currentState!.saveAndValidate()) {
      final activityCreateTask = ActivityCreateTask(
        activityTypeId: ActivityType.TASK_OBJECT.value,
        type: 'TASK',
