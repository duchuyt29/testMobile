...
class CrmAddFormCallPage extends GetView<CrmAddFormCallController> {
  @override
          ...
          title: Obx(
            () => Text(
              controller.isEdit.value
                  ? 'crm.activity.edit.call'.tr
                  : 'crm.activity.new.call'.tr,
          ...
          FormBuilder(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 15),
                  CrmWidgetBuildFormTextField(
                    title: 'crm.activity.phonenumber'.tr,
                    name: 'phonenumber',
                  ...
                  const SizedBox(height: 15),
                  CrmWidgetBuildFormTextField(
                    title: 'crm.activity.receiver1'.tr,
                    name: 'receiver',
                    controller: controller.involvedPeople,
