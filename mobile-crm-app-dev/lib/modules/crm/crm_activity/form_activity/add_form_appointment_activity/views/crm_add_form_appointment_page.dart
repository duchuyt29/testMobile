...
class CrmAddFormAppointmentPage
    extends GetView<CrmAddFormAppointmentController> {
  @override
          ...
          title: Obx(
            () => Text(
              controller.isEdit.value
                  ? 'crm.activity.edit.appointment'.tr
                  : 'crm.activity.appointment'.tr,
          ...
          FormBuilder(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 15),
                  CrmWidgetBuildFormTextField(
                    title: 'crm.activity.duration'.tr,
                    name: 'duration',
                  ...
                  const SizedBox(height: 15),
                  CrmWidgetBuildCombobox(
                    title: 'crm.activity.unit'.tr,
                    name: 'unit',
                    items: AppDataGlobal.crmMasterData?.listDurationUnit
                            ?.map((e) => e.durationUnitName ?? '')
                            .toList() ??
                        [],
                    onChanged: (value) {
                      controller.durationUnitId = AppDataGlobal
                              .crmMasterData?.listDurationUnit?[value].id ??
                          0;
                    },
                    initialValue: controller.isEdit.value
                        ? AppDataGlobal.crmMasterData?.listDurationUnit
                            ?.indexWhere((element) =>
                                element.id == controller.durationUnitId)
                        : null,
                    isRequired: true,
                  ),
                  const SizedBox(height: 15),
                  ...
                  CrmWidgetFormLabelBox(
                    ...
                    text: controller.participanterText.value,
                    onPress: controller.loadParticipantes,
                  ),
                  const SizedBox(height: 15),
                  CrmWidgetFormLabelBox(
