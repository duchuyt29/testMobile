...
class ActivityOrderPage extends GetView<ActivtyOrderController> {
  ActivityOrderPage({Key? key}) : super(key: key);
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(controller.filterData[i].orderNumber ?? ''),
