...
class ActivityLeadPage extends GetView<ActivtyLeadController> {
  ActivityLeadPage({Key? key}) : super(key: key);
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(controller.filterData[i].leadName ?? ''),
