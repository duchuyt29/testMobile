...
class ActivityQoutePage extends GetView<ActivtyQouteController> {
  ActivityQoutePage({Key? key}) : super(key: key);
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(controller.filterData[i].quoteName ?? ''),
