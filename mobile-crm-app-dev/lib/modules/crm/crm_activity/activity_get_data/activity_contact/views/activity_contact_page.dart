...
class ActivityContactPage extends GetView<ActivityContactController> {
  ActivityContactPage({Key? key}) : super(key: key);
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(controller.filterData[i].contactName ?? ''),
