...
class CrmRelevantPersonalPage extends GetView<CrmRelevantPersonalController> {
  @override
      ...
      children: [
        ...
        Expanded(
          child: Obx(() => ListView.separated(
                ...
                itemCount: controller.listAccountPartyInvolved.length,
                  ...
                  return CrmWidgetSlidable(
                    endActions: ActionPane(
                      ...
                      children: [
                          ...
                          child: SlidableAction(
                            onPressed: (context) {
                              controller.onViewUpdate(
                                  controller.listAccountPartyInvolved[index]);
                            },
                        ...
                        if (controller.listAccountPartyInvolved[index].isMain !=
                            1)
                          Visibility(
                            visible: AppDataGlobal
                                    .userConfig
                            ...
                            child: SlidableAction(
                              onPressed: (context) {
                                controller.onDeleteAccount(controller
                                        .listAccountPartyInvolved[index].id ??
                                    0);
                              },
                    ...
                    child: _buildListItems(
                        item: controller.listAccountPartyInvolved[index]),
                  );
                },
  ...
  Container _buildListItems({
    required AccountPartyInvolved item,
  }) {
    return Container(
