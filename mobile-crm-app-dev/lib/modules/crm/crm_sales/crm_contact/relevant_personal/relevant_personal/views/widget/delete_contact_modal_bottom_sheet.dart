...
class DeleteContactModalBottomSheetRelevantPersonal extends StatelessWidget {
  const DeleteContactModalBottomSheetRelevantPersonal({
    Key? key,
  }) : super(key: key);
        ...
        children: [
          Column(
            children: [
              ...
              Container(
                child: Text('Bạn có chắc chắn muốn xóa Vũ Hồng Anh ?',
