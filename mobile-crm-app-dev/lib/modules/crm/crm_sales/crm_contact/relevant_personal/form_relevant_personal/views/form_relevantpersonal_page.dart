...
class CrmCreateRelevantPersonalPage
    extends GetView<CrmCreateRelevantPersonalController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          controller.contactPartyInvolved?.id == null
              ...
              child: Column(
                ...
                children: [
                  ...
                  Obx(() => CrmWidgetFormLabelBox(
                        ...
                        disable: controller.contactPartyInvolved?.id != null &&
                            controller.contactPartyInvolved?.isMain != 1,
                        onPress: controller.contactPartyInvolved?.id == null ||
                                controller.contactPartyInvolved?.isMain == 1
