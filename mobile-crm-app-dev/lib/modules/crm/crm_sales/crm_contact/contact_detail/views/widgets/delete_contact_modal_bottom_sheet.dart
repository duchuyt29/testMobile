...
class DeleteContactModalBottomSheet extends StatelessWidget {
  const DeleteContactModalBottomSheet({
    Key? key,
  }) : super(key: key);
      ...
      Column(
        children: [
          Column(
            children: [
              Container(
                child: Text('Xóa Người liên hệ'.tr,
                    style: AppTextStyle.bold(fontSize: 20)),
              ),
              Container(
                child: Text('Bạn có chắc chắn muốn xóa liên hệ ......?',
                    style: AppTextStyle.regular(fontSize: 16)),
              ),
              Container(
                child: Text('Liên hệ sẽ bị xóa vĩnh viễn',
                    style: AppTextStyle.regular(fontSize: 16)),
              )
            ],
          ),
