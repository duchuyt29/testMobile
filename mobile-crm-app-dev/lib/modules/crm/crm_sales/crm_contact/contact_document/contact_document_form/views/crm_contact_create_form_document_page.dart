...
class CrmCreateFormContactDocumentPage
    extends GetView<CrmCreateFormContactDocumentController> {
  const CrmCreateFormContactDocumentPage({Key? key}) : super(key: key);
