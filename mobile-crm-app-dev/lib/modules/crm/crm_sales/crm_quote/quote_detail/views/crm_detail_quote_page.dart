    ...
    return Stack(children: [
      Column(
        children: [
          ...
          _buildListView(title: 'Thông tin chi tiết', ontap: () {}),
          _buildListView(title: 'Nhân sự liên quan', ontap: () {}),
          _buildListView(title: 'Tài liệu', ontap: () {}),
          _buildListView(title: 'Sản phẩm', ontap: () {}),
          //  controller.onViewQuoteProduct),
        ],
      ),
      SlidingUpPanel(
