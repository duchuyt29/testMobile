...
class CrmProductFamilyController extends GetxController {
  ...
  Future<void> overviewProductFamily() async {
    await Get.toNamed(CRMRoutes.CRM_PRODUCT_FAMILY_OVERVIEW);
  }

  Future<void> addNewProductFamily() async {
