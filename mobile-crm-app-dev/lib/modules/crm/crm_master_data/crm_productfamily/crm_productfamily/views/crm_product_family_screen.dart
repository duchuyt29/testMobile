...
class CrmProductFamilyScreen extends GetView<CrmProductFamilyController> {
  CrmProductFamilyScreen({Key? key}) : super(key: key);
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            TextButton(
                onPressed: controller.addNewProductFamily,
        ...
        Container(
          child: ListTile(
              ...
              onTap: () {
                controller.overviewProductFamily();
              }),
        ),
        Container(
          height: 10,
