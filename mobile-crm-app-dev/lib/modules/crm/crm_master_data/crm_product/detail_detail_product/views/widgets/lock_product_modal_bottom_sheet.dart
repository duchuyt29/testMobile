...
class LockProductModalBottomSheet extends StatelessWidget {
  const LockProductModalBottomSheet({
    Key? key,
  }) : super(key: key);
        ...
        children: [
          Column(
            children: [
              ...
              Container(
                child: Text('Bạn có chắc chắn muốn khóa "dịch vụ ...."?',
                    style: AppTextStyle.regular(fontSize: 16)),
              ),
              Container(
                child: Text(
                    'Giá cảu sản phẩm không thể thao tác sau khi bị khóa',
                    style: AppTextStyle.regular(fontSize: 16)),
              )
            ],
          ),
          ...
          _buildListTile(title: 'crm.key'.tr, onTap: () {}),
          InkWell(
            onTap: Get.back,
            child: Container(
