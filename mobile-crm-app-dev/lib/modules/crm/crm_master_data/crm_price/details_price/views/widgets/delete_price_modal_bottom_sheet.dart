...
class CreateDeletePriceModalBottomSheet extends StatelessWidget {
  const CreateDeletePriceModalBottomSheet({
    Key? key,
  }) : super(key: key);
        ...
        children: [
          Column(
            children: [
              ...
              Container(
                child: Text('Bạn có chắc chắn muốn xóa bảng giá?',
                    style: AppTextStyle.regular(fontSize: 16)),
              ),
              Container(
                child: Text('Bảng giá sẽ bị xóa vĩnh viễn',
                    style: AppTextStyle.regular(fontSize: 16)),
              )
            ],
          ),
