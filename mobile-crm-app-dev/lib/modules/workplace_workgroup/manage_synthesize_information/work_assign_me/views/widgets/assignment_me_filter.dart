...
class AssignmentMeFilterPage extends StatelessWidget {
  const AssignmentMeFilterPage({Key? key}) : super(key: key);
          ...
          FormBuilder(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 20),
                _buildComboBox(title: 'crm.activity.requester'.tr, name: ''),
                const SizedBox(height: 20),
                Row(
                  children: [
                    Expanded(
