...
class WorkFormTicketPage extends GetView<WorkFormTicketController> {
  const WorkFormTicketPage({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  CrmWidgetBuildCombobox(
                      isRequired: true,
                      title: 'workplace.workgroup.ticket'.tr,
                      name: '',
                      items: [],
                      onChanged: (id) {}),
                  const SizedBox(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CrmWidgetBuildFormTextField(
                            title: 'workplace.workgroup.processing.group'.tr,
                            name: '',
                            controller: null,
                            textInputType: TextInputType.name),
                      )
