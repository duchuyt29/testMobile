...
class DetailWorkProjectPage extends GetView<DetailWorkProjectController> {
  DetailWorkProjectPage({Key? key}) : super(key: key);
          ...
          PopupMenuButton<int>(
            ...
            onSelected: (value) {
              switch (value) {
                case 1:
                  Get.toNamed(
                      WorkGroupRoutes.WORKPLACE_WORKGROUP_WORK_FORM_PROJECT);
                  break;
                case 2:
                  break;
                case 3:
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          _buildItemRow(
              title: 'workplace.workgroup.work.packget'.tr, name: 'Dự án '),
          _buildItemRow(
              title: 'workplace.workgroup.petitioner'.tr,
              name: 'Nguyễn Hồng Em'),
          _buildItemRow(title: 'Name'.tr, name: 'Nguyễn Hồng Em'),

          _buildItemRow(
              title: 'workplace.workgroup.belonging'.tr, name: 'Dự án'),
          _buildItemRow(
          ...
          _buildItemRow(
              title: 'workplace.workgroup.processing.time'.tr, name: '11:11'),
          _buildItemRow(
