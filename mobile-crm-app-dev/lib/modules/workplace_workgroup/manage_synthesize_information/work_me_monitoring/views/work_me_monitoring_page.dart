...
import 'widgets/me_monitoring_filter.dart';

class TheMeMonitoringPage extends GetView<TheMeMonitoringController> {
  TheMeMonitoringPage({Key? key}) : super(key: key);
  ...
  Widget _buildBodyContent() {
    return DefaultTabController(
      ...
      child: Scaffold(
        key: scaffoldKey,
        endDrawer: const MeMonitoringFilterPage(),
        appBar: AppBar(
          ...
          title: Text(
            'workplace.workgroup.me.monitoring'.tr,
