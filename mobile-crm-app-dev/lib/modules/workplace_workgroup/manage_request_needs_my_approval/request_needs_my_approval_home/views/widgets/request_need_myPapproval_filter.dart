...
class RequestNeedMyAppovalFilterPage extends StatelessWidget {
  const RequestNeedMyAppovalFilterPage({Key? key}) : super(key: key);
          ...
          FormBuilder(
            ...
            child: Column(
              children: [
                ...
                _buildComboBox(
                    title: 'workplace.workgroup.process'.tr, name: ''),
                const SizedBox(height: 20),
                Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        'workplace.workgroup.approver'.tr,
                ...
                Row(
                  children: [
                    Expanded(
                        child: _buildItem(
                            title: 'workplace.workgroup.day.start.from'.tr)),
                    const SizedBox(
                      width: 10,
                    ),
                    Expanded(
                        child: _buildItem(
                            title: 'workplace.workgroup.day.start.come'.tr))
                  ],
                ),
                const SizedBox(height: 20),
                Row(
